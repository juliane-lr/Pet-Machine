public class PetMachine {
    ...
    public void takeShower() {
        ...
        if (this.water < 10 || this.shampoo < 2) {
            System.out.println("Não há água ou shampoo suficientes para realizar o banho.");
            return;
        }
    ...
    public void setPet(Pet pet) {
        ...
        // A máquina só pode ter um pet por vez.
        if (hasPet()) {
    ...
    public void washMachine() {
        if (this.water < 3 || this.shampoo < 1) {
            System.out.println("Não há água ou shampoo suficientes para limpar a máquina.");
            return;
        }
